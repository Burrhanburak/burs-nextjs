...
const navigation = [
  ...
  { name: "Başvurularım", href: "/user/dashboard/applications", icon: RiFileList3Line },
  { name: "Belgelerim", href: "/user/documents", icon: RiFileList3Line },
  { name: "Bildirimlerim", href: "/user/dashboard/notifications", icon: RiNotification3Line },
  { name: "Profilim", href: "/user/dashboard/profile", icon: RiUser3Line },
] as const
