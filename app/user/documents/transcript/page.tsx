  ...
  const saveDocument = async (file: File, fileUrl: string) => {
    try {
      ...
      const response = await fetch('/api/documents', {
        ...
        body: JSON.stringify({
          url: fileUrl,
          type: 'transcript' // Belge türünü transcript olarak değiştirdik
        }),
      });
      ...
      toast.success("Transkript belgeniz başarıyla yüklendi");
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold">Transkript Yükleme</h1>
      </div>
      ...
      {isUploaded ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Transkript belgeniz başarıyla yüklendi
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground mb-4">
              Transkript belgeniz başarıyla yüklendi. Belge incelendikten sonra size bildirim gönderilecektir.
            </p>
            {uploadedUrl && (
              <Button 
                variant="outline" 
        ...
        <Card>
          <CardHeader>
            <CardTitle>Transkript Yükleme</CardTitle>
            <CardDescription>
              Üniversitenizden alacağınız transkript belgesini yükleyin
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="bg-blue-50 dark:bg-blue-950/10 p-4 rounded-lg border border-blue-100 dark:border-blue-900">
        ...
        <ul className="mt-2 text-sm text-blue-700 dark:text-blue-400 space-y-1 list-disc pl-5">
          <li>Transkript belgesi üniversitenizden alınmış olmalıdır.</li>
          <li>Belgede notlarınızın tamamı görülmelidir.</li>
          <li>Genel not ortalamanız (GNO) belge üzerinde görülmelidir.</li>
          <li>Tüm ders bilgilerinizin okunabilir olduğundan emin olun.</li>
        </ul>
      </div>
    </div>
  )
